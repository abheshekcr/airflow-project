...
#
 airflow connections add aws_credentials --conn-uri 'aws://AKIA3ORJ6NATWAQ3YJTQ:97r4n3DtKRz77dTZnrYv1AH4pKO6G8hdrKMTd1UK@'
#
#
# TO-DO: run the follwing command and observe the JSON output: 
...
# TO-DO: Update the following command with the URI and un-comment it:
#
 airflow connections add redshift --conn-uri 'redshift://awsuser:Abheshek007@my-workspace.787140732967.us-east-1.redshift-serverless.amazonaws.com:5439/dev'
#
# TO-DO: update the following bucket name to match the name of your S3 bucket and un-comment it:
#
 airflow variables set s3_bucket airflow-bucket123
#
